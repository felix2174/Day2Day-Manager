                            ...
                            ?>
                                ...
                                <div class="gantt-project-row" data-project-id="<?php echo e($project->id); ?>" style="border: 1px solid #e5e7eb; border-radius: 8px; background: white; padding: 16px; display: flex; flex-direction: column; gap: 16px;">
                                    ...
                                    <div style="display: flex; flex-direction: column; gap: 8px;">
                                        ...
                                        ?>
                                        <?php $__empty_1 = true; $__currentLoopData = $employeeDataByEmployee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeId => $employeeData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                                            ...
                                            <div style="display: grid; grid-template-columns: 260px 1fr; gap: 12px; align-items: center; margin-top: 8px;">
                                                <div style="height: 28px; display: flex; align-items: center; background: #f3f4f6; border: 1px solid #d1d5db; border-radius: 8px; padding: 0 12px; color: #111827; font-size: 13px; font-weight: 600; gap: 8px;">
                                                    ...
                                                    <span class="employee-name" 
                                                          ...
                                                          data-task-count="<?php echo e(count($employeeTasks)); ?>"
                                                          data-total-hours="<?php echo e($employeeTasks->sum('weekly_hours')); ?>"
                                                          style="cursor: pointer;"
                                                          title="<?php echo e($employeeName); ?> (<?php echo e($source === 'assignment' ? 'Aufgaben' : 'MOCO'); ?>)">
                                                        <?php echo e($employeeName); ?>

                                                        <?php if($source !== 'assignment'): ?>
                                                ...
                                                <div style="position: relative; height: 28px; border-radius: 8px; background: #f9fafb; border: 1px solid #e5e7eb;">
                                                    <?php $__currentLoopData = $employeeTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taskIndex => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                        ...
                                                        <div class="project-task-bar" 
                                                             ...
                                                             data-task-description="<?php echo e($task['task_description'] ?? ''); ?>"
                                                             data-start-date="<?php echo e($taskStart->format('d.m.Y')); ?>"
                                                             data-end-date="<?php echo e($taskEnd->format('d.m.Y')); ?>"
                                                             data-weekly-hours="<?php echo e($hours ?? 0); ?>"
                                                             data-duration-days="<?php echo e($taskStart->diffInDays($taskEnd) + 1); ?>"
                                                             data-source="<?php echo e($taskType); ?>"
