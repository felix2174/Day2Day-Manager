                                            ...
                                            <div style="position: relative; height: <?php echo e($timelineHeight); ?>px;">
                                                ...
                                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projectIndex => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="employee-project-row" data-assignment-id="<?php echo e($project['assignment_ids']->first()); ?>" data-employee-id="<?php echo e($employee->id); ?>" data-start-date="<?php echo e($project['start']->toDateString()); ?>" data-end-date="<?php echo e($project['end']->toDateString()); ?>" style="position: absolute; left: <?php echo e($leftPercent); ?>%; top: <?php echo e($projectIndex * 32); ?>px; width: <?php echo e($widthPercent); ?>%; height: 24px; z-index: 3; cursor: grab;">
                                                        <div class="employee-project-bar" style="width: 100%; height: 100%; border-radius: 12px; background: <?php echo e($bgColor); ?>; border: <?php echo e($borderStyle); ?>; display: flex; align-items: center; justify-content: center; color: <?php echo e($isOverdue ? '#ffffff' : '#0f172a'); ?>; font-size: 12px; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.15);">
                                                            <span style="padding: 0 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="<?php echo e($project['project_name']); ?><?php echo e($isOverdue ? ' (Überfällig)' : ''); ?>"><?php echo e(Str::limit($project['project_name'], 32)); ?></span>
                                                            <?php if($hours): ?>
                                                                <span style="margin-left: 8px; font-weight: 600; background: rgba(<?php echo e($isOverdue ? '255,255,255' : '15,23,42'); ?>,0.1); padding: 2px 6px; border-radius: 12px;"><?php echo e($hours); ?>h</span>
                                                            <?php endif; ?>
                                                            <?php if($isOverdue): ?>
...
<?php /**PATH C:\xampp\htdocs\Day2Day-Manager\resources\views/gantt/partials/timeline-employees.blade.php ENDPATH**/ ?>