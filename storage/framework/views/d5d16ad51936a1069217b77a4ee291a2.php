...
function debugProject() {
    ...
    window.open(`/moco/debug/project/${projectId}`, '_blank');
            ...
            <?php if($lastFailedSync): ?>
                <div style="background: #fef3c7; border: 1px solid #fcd34d; border-radius: 8px; padding: 16px; margin-bottom: 16px; color: #92400e;">
                    <strong>Letzter fehlgeschlagener Sync:</strong> <?php echo e($lastFailedSync->sync_type); ?> am <?php echo e($lastFailedSync->started_at->format('d.m.Y H:i')); ?> – <?php echo e($lastFailedSync->error_message ?? 'Keine Fehlermeldung vorhanden'); ?>.
                </div>
            <?php endif; ?>
            ...
            <?php if(!empty($syncWarnings)): ?>
                <div style="background: #dbeafe; border: 1px solid #93c5fd; border-radius: 8px; padding: 16px; margin-bottom: 16px; color: #1e40af;">
                    ...
                    <ul style="margin: 12px 0 0 20px; color: #1e3a8a;">
                        <?php $__currentLoopData = $syncWarnings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warning): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div style="padding: 20px; color: #111827;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            ...
                            <div style="display: flex; align-items: center; gap: 8px; color: <?php echo e($connectionStatus ? '#059669' : '#b91c1c'); ?>;">
                                <?php if($connectionStatus): ?>
                            ...
                            <div style="margin-top: 8px; color:#6b7280; font-size: 12px;">
                                <?php if($lastConnectionCheck): ?>
                                    Letzter erfolgreicher Health-Check: <?php echo e(\Carbon\Carbon::parse($lastConnectionCheck)->diffForHumans()); ?>
                        ...
                        <form action="<?php echo e(route('moco.test')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <div style="padding: 20px;">
                        ...
                        <div>
                            <div style="display:flex; justify-content: space-between; color:#6b7280; font-size:14px;">
                                <span>Gesamt:</span>
                                <span style="color:#111827; font-weight:600;"><?php echo e($stats['employees']['total']); ?></span>
                            </div>
                            <div style="display:flex; justify-content: space-between; color:#6b7280; font-size:14px;">
                                <span>Mit MOCO-ID:</span>
                                <span style="color:#059669; font-weight:600;"><?php echo e($stats['employees']['synced']); ?></span>
                            </div>
                        </div>
                        <?php if($lastSyncs['employees']): ?>
                        <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid #e5e7eb; color:#6b7280; font-size:12px;">Letzte Sync: <?php echo e($lastSyncs['employees']->completed_at->diffForHumans()); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div style="grid-column: span 12 / span 12; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                    <div style="padding: 20px;">
                        ...
                        <div>
                            <div style="display:flex; justify-content: space-between; color:#6b7280; font-size:14px;">
                                <span>Gesamt:</span>
                                <span style="color:#111827; font-weight:600;"><?php echo e($stats['projects']['total']); ?></span>
                            </div>
                            <div style="display:flex; justify-content: space-between; color:#6b7280; font-size:14px;">
                                <span>Mit MOCO-ID:</span>
                                <span style="color:#7c3aed; font-weight:600;"><?php echo e($stats['projects']['synced']); ?></span>
                            </div>
                        </div>
                        <?php if($lastSyncs['projects']): ?>
                        <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid #e5e7eb; color:#6b7280; font-size:12px;">Letzte Sync: <?php echo e($lastSyncs['projects']->completed_at->diffForHumans()); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div style="grid-column: span 12 / span 12; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                    <div style="padding: 20px;">
                        ...
                        <div>
                            <div style="display:flex; justify-content: space-between; color:#6b7280; font-size:14px;">
                                <span>Gesamt:</span>
                                <span style="color:#111827; font-weight:600;"><?php echo e($stats['timeEntries']['total']); ?></span>
                            </div>
                            <div style="display:flex; justify-content: space-between; color:#6b7280; font-size:14px;">
                                <span>Mit MOCO-ID:</span>
                                <span style="color:#f59e0b; font-weight:600;"><?php echo e($stats['timeEntries']['synced']); ?></span>
                            </div>
                        </div>
                        <?php if($lastSyncs['activities']): ?>
                        <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid #e5e7eb; color:#6b7280; font-size:12px;">Letzte Sync: <?php echo e($lastSyncs['activities']->completed_at->diffForHumans()); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; margin-bottom: 20px;">
                <div style="padding: 20px; color:#111827;">
                    ...
                    <form action="<?php echo e(route('moco.sync-all')); ?>" method="POST" onsubmit="return handleFullSync(event)">
                        <?php echo csrf_field(); ?>
            ...
            <div style="display: grid; grid-template-columns: repeat(12, minmax(0, 1fr)); gap: 20px;">
                ...
                <div style="grid-column: span 12 / span 12; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                    <div style="padding: 20px; color:#111827;">
                        ...
                        <form action="<?php echo e(route('moco.sync-employees')); ?>" method="POST" onsubmit="handleSyncSubmit(event, this, 'Mitarbeiter werden synchronisiert...')">
                            <?php echo csrf_field(); ?>
                ...
                <div style="grid-column: span 12 / span 12; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                    <div style="padding: 20px; color:#111827;">
                        ...
                        <form action="<?php echo e(route('moco.sync-projects')); ?>" method="POST" onsubmit="handleSyncSubmit(event, this, 'Projekte werden synchronisiert...')">
                            <?php echo csrf_field(); ?>
                            <label style="display:flex; align-items:center; gap:8px; margin-bottom: 12px; color:#374151; font-size:14px;">
                                <input type="checkbox" name="active_only" value="1">
                                <span>Nur aktive</span>
                ...
                <div style="grid-column: span 12 / span 12; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                    <div style="padding: 20px; color:#111827;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                            ...
                            <?php if($lastTimeSync): ?>
                                <span style="color:#6b7280; font-size:12px;">
                                    🕐 Vor <?php echo e($lastTimeSync->diffForHumans(null, true)); ?>
                        ...
                        <form action="<?php echo e(route('moco.sync-activities')); ?>" method="POST" onsubmit="handleSyncSubmit(event, this, 'Zeiterfassungen werden synchronisiert...')">
                            <?php echo csrf_field(); ?>
                ...
                <div style="grid-column: span 12 / span 12; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                    <div style="padding: 20px; color:#111827;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                            ...
                            ?>
                            <?php if($lastAbsenceSync): ?>
                                <span style="color:#6b7280; font-size:12px;">
                                    🕐 Vor <?php echo e($lastAbsenceSync->diffForHumans(null, true)); ?>
                        ...
                        <form action="<?php echo e(route('moco.sync-absences')); ?>" method="POST" onsubmit="handleSyncSubmit(event, this, 'Abwesenheiten werden synchronisiert...')">
                            <?php echo csrf_field(); ?>
                            <label style="display:flex; align-items:center; gap:8px; margin-bottom: 12px; color:#6b7280; font-size:14px;">
                                <span>Letzte</span>
                                <input type="number" name="days" value="30" min="1" max="365" style="width: 60px; padding: 6px 8px; border: 1px solid #e5e7eb; border-radius: 6px;">
                ...
                <div style="grid-column: span 12 / span 12; background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                    <div style="padding: 20px; color:#111827;">
                        ...
                        <form action="<?php echo e(route('moco.sync-contracts')); ?>" method="POST" onsubmit="return handleContractsSync(event)">
                            <?php echo csrf_field(); ?>
            ...
            <div style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; margin-bottom: 20px;">
                <div style="padding: 20px; color:#111827;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 12px;">
                        <!-- All Users -->
                        <a href="<?php echo e(route('moco.debug.users')); ?>" target="_blank" 
                        ...
                        <!-- All Projects -->
                        <a href="<?php echo e(route('moco.debug.projects')); ?>" target="_blank"
                           style="display: block; padding: 12px; background: #f3f4f6; border: 1px solid #e5e7eb; border-radius: 6px; text-decoration: none; color: #374151; font-size: 14px; text-align: center; transition: all 0.2s;"
                           onmouseover="this.style.background='#e5e7eb'" onmouseout="this.style.background='#f3f4f6'">
                        ...
                        <!-- All Activities -->
                        <a href="<?php echo e(route('moco.debug.activities')); ?>" target="_blank"
                           style="display: block; padding: 12px; background: #f3f4f6; border: 1px solid #e5e7eb; border-radius: 6px; text-decoration: none; color: #374151; font-size: 14px; text-align: center; transition: all 0.2s;"
                           onmouseover="this.style.background='#e5e7eb'" onmouseout="this.style.background='#f3f4f6'">
                        ...
                        <!-- All Absences -->
                        <a href="<?php echo e(route('moco.debug.absences')); ?>" target="_blank"
                           style="display: block; padding: 12px; background: #f3f4f6; border: 1px solid #e5e7eb; border-radius: 6px; text-decoration: none; color: #374151; font-size: 14px; text-align: center; transition: all 0.2s;"
                           onmouseover="this.style.background='#e5e7eb'" onmouseout="this.style.background='#f3f4f6'">
            ...
            <div style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px;">
                <div style="padding: 20px; color:#111827;">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="<?php echo e(route('moco.logs')); ?>" style="color:#1d4ed8; text-decoration:none; font-size:14px;">
                            Alle anzeigen →
                        </a>
                    </div>
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tbody>
                                ...
                                <tr style="border-top: 1px solid #e5e7eb;">
                                    ...
                                    <td style="padding:10px; font-size:14px;"><?php echo e($log->items_processed); ?></td>
                                    <td style="padding:10px; font-size:14px; color:#059669;"><?php echo e($log->items_created); ?></td>
                                    <td style="padding:10px; font-size:14px; color:#2563eb;"><?php echo e($log->items_updated); ?></td>
                                    <td style="padding:10px; font-size:14px;"><?php echo e($log->getDurationFormatted()); ?></td>
                                    <td style="padding:10px; font-size:14px; color:#6b7280;">
                                        <?php echo e($log->started_at->diffForHumans()); ?>
...
<?php echo $__env->make('moco.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Day2Day-Manager\resources\views/moco/index.blade.php ENDPATH**/ ?>