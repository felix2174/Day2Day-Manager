                                ...
                                <div class="gantt-project-row" data-project-id="<?php echo e($project->id); ?>" style="border: 1px solid #e5e7eb; border-radius: 8px; background: white; padding: 16px; display: flex; flex-direction: column; gap: 16px;">
                                    <div style="display: grid; grid-template-columns: 260px 1fr; gap: 12px; align-items: center;">
                                        <div style="display: flex; align-items: center; gap: 8px;">
                                            ...
                                            <div style="font-weight: 600; color: #111827; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e($project->name); ?></div>
                                        </div>
                                        <div style="position: relative; height: 24px; border: 1px solid #e5e7eb; border-radius: 12px; background: #f9fafb;">
                                            ...
                                            ?>
                                            <?php if($shouldDisplayProject): ?>
                                            <div class="gantt-bar" data-project-name="<?php echo e($project->name); ?>" data-start-date="<?php echo e($projectStart->format('d.m.Y')); ?>" data-end-date="<?php echo e($projectEnd->format('d.m.Y')); ?>" data-deadline="<?php echo e($projectEnd->format('d.m.Y')); ?>" data-days-until-deadline="<?php echo e($daysUntilDeadline); ?>" data-is-overdue="<?php echo e($isOverdue ? 'true' : 'false'); ?>" data-required-hours="<?php echo e((int)round($metrics['requiredPerWeek'])); ?>" data-available-hours="<?php echo e((int)round($metrics['availablePerWeek'])); ?>" data-progress="<?php echo e($progress); ?>" data-status="<?php echo e(ucfirst($project->status)); ?>" data-capacity-ratio="<?php echo e($metrics['capacityRatio'] ?? ''); ?>" data-risk-score="<?php echo e(round($metrics['riskScore'])); ?>" data-responsible="<?php echo e($responsibleName); ?>" data-team-size="<?php echo e($teamSize); ?>" data-total-hours="<?php echo e($totalPlannedHours); ?>" data-weekly-hours="<?php echo e($totalWeeklyHours); ?>" data-duration-weeks="<?php echo e($projectDurationWeeks); ?>" style="position: absolute; top: 0; height: 100%; border-radius: 12px; background: <?php echo e($statusColor); ?>; left: <?php echo e($projectLeftPercent); ?>%; width: <?php echo e($projectWidthPercent); ?>%; min-width: 1.5%; display: flex; align-items: center; justify-content: space-between; color: white; font-size: 12px; font-weight: 600; box-shadow: 0 2px 6px rgba(0,0,0,0.15); padding: 0 8px; cursor: pointer; <?php echo e($extendsRight ? 'border-right: 3px dashed rgba(255,255,255,0.7);' : ''); ?>">
                                                <span style="padding: 0 4px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; flex: 1;"><?php echo e(Str::limit($project->name, 32)); ?></span>
                                                <div style="display: flex; align-items: center; gap: 6px; flex-shrink: 0;">
                                                    <span style="font-weight: 600; background: rgba(255,255,255,0.2); padding: 2px 6px; border-radius: 12px;"><?php echo e($progress); ?>%</span>
                                                    <?php if($isOverdue): ?>
                                                        <span style="font-size: 14px; filter: drop-shadow(0 0 2px rgba(0,0,0,0.3));" title="Überfällig seit <?php echo e(now()->diffInDays($projectEnd)); ?> Tagen">⚠️</span>
                                                    <?php elseif($isDueSoon): ?>
                                                        <span style="font-size: 14px; filter: drop-shadow(0 0 2px rgba(0,0,0,0.3));" title="Fällig in <?php echo e($projectEnd->diffInDays(now())); ?> Tagen">🕐</span>
                                                    <?php elseif($extendsLeft): ?>
                                                        <span style="font-size: 14px; filter: drop-shadow(0 0 2px rgba(0,0,0,0.3));" title="Begann vor Timeline">←</span>
                                                    <?php elseif($extendsRight): ?>
        ...
        <form id="bulkAssignForm" onsubmit="submitBulkAssign(event)">
            ...
            <div style="padding: 20px; max-height: 50vh; overflow-y: auto;">
                <div style="margin-bottom: 16px;">
                    ...
                    <?php if($availableEmployees->isEmpty()): ?>
...
<?php /**PATH C:\xampp\htdocs\Day2Day-Manager\resources\views/gantt/partials/timeline-projects.blade.php ENDPATH**/ ?>