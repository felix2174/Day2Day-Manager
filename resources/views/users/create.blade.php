<x-app-layout>
    <div style="max-width: 800px; margin: 0 auto; padding: 24px;">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <h1 style="font-size: 28px; font-weight: 600; color: #111827; margin: 0;">Neuen Benutzer erstellen</h1>
        </div>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="password" name="password" required
                           style="width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 8px; font-size: 14px;">
                    <div style="color: #6b7280; font-size: 13px; margin-top: 4px;">Mindestens 8 Zeichen</div>
                    @error('password')
                        <div style="color: #ef4444; font-size: 13px; margin-top: 4px;">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display: block; font-weight: 500; color: #374151; margin-bottom: 8px;">
                        Passwort bestätigen <span style="color: #ef4444;">*</span>
                    </label>
