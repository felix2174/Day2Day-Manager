...
@section('title', 'Abwesenheit Import')
...
<div style="width: 100%; margin: 0; padding: 0;">
    ...
    <div style="background: white; padding: 20px; margin-bottom: 20px; border: 1px solid #e5e7eb; border-radius: 8px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1 style="font-size: 24px; font-weight: bold; color: #111827; margin: 0;">Abwesenheit Import</h1>
                <p style="color: #6b7280; margin: 5px 0 0 0;">Importieren Sie Abwesenheiten aus einer CSV-Datei</p>
            </div>
    ...
    <div style="background: white; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px;">
        <form action="{{ route('absences.import.process') }}" method="POST" enctype="multipart/form-data" style="max-width: 600px;">
            @csrf
            ...
            <div style="background: #f9fafb; padding: 15px; border-radius: 6px; margin-bottom: 20px;">
                ...
                <div style="font-family: monospace; font-size: 12px; color: #374151; background: white; padding: 10px; border-radius: 4px; border: 1px solid #e5e7eb;">
                    Mitarbeiter;Typ;Startdatum;Enddatum;Grund
                </div>
                <p style="color: #6b7280; font-size: 12px; margin: 8px 0 0 0;">Beispiel: Max Mustermann;Urlaub;01.07.2024;15.07.2024;Sommerurlaub</p>
                <p style="color: #6b7280; font-size: 12px; margin: 4px 0 0 0;">Typen: Urlaub, Krank, Fortbildung</p>
                <p style="color: #ef4444; font-size: 12px; margin: 8px 0 0 0;">⚠️ Mitarbeiter muss bereits existieren!</p>
            </div>
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <a href="{{ route('absences.index') }}" style="background: #ffffff; color: #374151; padding: 12px 24px; border: 1px solid #d1d5db; border-radius: 8px; text-decoration: none; font-size: 14px; display: inline-block;">Abbrechen</a>
            </div>
        </form>
    </div>
</div>
